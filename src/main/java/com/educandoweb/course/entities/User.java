...
public class User implements Serializable {
    ...
    @JsonIgnore // Evitar loop por causa da relação de mão dupla
    @OneToMany(mappedBy = "client")
    private List<Order> orders = new ArrayList<>(); // Instanciando coleção
    ...
    // Lembre-se: Coleções você só implementa o get!
