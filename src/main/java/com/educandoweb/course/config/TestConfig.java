...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        OrderItem oi1 = new OrderItem(o1, p1, 2, p1.getPrice()); // Pedido 1, produto 1, quantidade 2 e o preço é o preço do pedido
        ...
        Payment pay1 = new Payment(null, Instant.parse("2019-06-20T21:53:07Z"), o1); // Pedido o1 já foi pago
        o1.setPayment(pay1);
